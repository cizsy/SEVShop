      ...
      <header class="app-header">
          <nav class="navbar">
            <ul class="navbar-left">
              <li class="nav-item">
                <button class="sidebartoggler" id="headerCollapse">
                  ☰
                </button>
              </li>
            ...
            <div class="navbar-right">
              <div class="nav-item dropdown">
                <a class="nav-link" href="#" id="profileBtn">
                  <img src="assets/images/profile/user-1.jpg" alt="User" width="35" height="35" class="profile-img">
                </a>
                <div class="dropdown-menu right" id="profileMenu">
